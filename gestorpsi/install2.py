...
# Professional
grp_professional = Group.objects.create(name='professional')
...
grp_professional.permissions.add(Permission.objects.get(codename='contacts_write'))
grp_professional.permissions.add(Permission.objects.get(codename='contacts_read'))
grp_professional.permissions.add(Permission.objects.get(codename='contacts_list'))
...
grp_professional.permissions.add(Permission.objects.get(codename='professional_write'))
grp_professional.permissions.add(Permission.objects.get(codename='professional_read'))
grp_professional.permissions.add(Permission.objects.get(codename='professional_list'))
