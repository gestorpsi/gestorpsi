...
from packages.paypal.standard.models import PayPalStandardBase
from packages.paypal.standard.conf import POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT
from packages.paypal.standard.pdt.signals import pdt_successful, pdt_failed
...
class PayPalPDT(PayPalStandardBase):
    ...
    def _verify_postback(self):
        ...
        from packages.paypal.standard.pdt.forms import PayPalPDTForm
        result = False
