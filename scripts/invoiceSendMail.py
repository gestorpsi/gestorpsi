...
def invoice_sendmail():
    ...
    for d in 4, 10:
        ...
        #for i in Invoice.objects.filter(expiry_date=expiry, status=0, organization__suspension=False, organization__short_name='IPC'): # debug code
