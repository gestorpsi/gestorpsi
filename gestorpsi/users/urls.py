...
from gestorpsi.users.views import index, list, form, create_user, update_user, update_pwd, set_form_user, add, order, username_is_available, delete #, form_new_user (WILL BE DELETED)
