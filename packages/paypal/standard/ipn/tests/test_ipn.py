...
from packages.paypal.standard.ipn.models import PayPalIPN
from packages.paypal.standard.ipn.signals import (payment_was_successful, 
    payment_was_flagged)
...
class IPNTest(TestCase):    
    urls = 'packages.paypal.standard.ipn.tests.test_urls'
