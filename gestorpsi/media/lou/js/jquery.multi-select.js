  ...
  var msMethods = {
    'init' : function(options){
      ...
      return multiSelects.each(function(){
        ...
        if (ms.next('.ms-container').length == 0){
          ...
          $('.ms-elem-selectable', selectableUl).live('mouseenter', function(){
          ...
          selectableUl.live('focusin', function(){
          ...
          selectedUl.live('focusin', function(){
            $(this).addClass('ms-focus');
          }).live('focusout', function(){
            $(this).removeClass('ms-focus');
            $('li', container).removeClass('ms-hover');
          ...
          ms.liveKeyDown = function(e, keyContainer){
    ...
    'select' : function(value, method){
      ...
      if (haveToSelect && selectedUl.children('li[ms-value="'+value+'"]').length == 0){
        ...
        selectedLi.live('mouseenter', function(){
