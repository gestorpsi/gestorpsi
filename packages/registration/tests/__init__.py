...
from packages.registration.tests.backends import *
from packages.registration.tests.forms import *
from packages.registration.tests.models import *
from packages.registration.tests.views import *
