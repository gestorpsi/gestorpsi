...
from packages.paypal.pro.forms import PaymentForm, ConfirmForm
from packages.paypal.pro.models import PayPalNVP
from packages.paypal.pro.helpers import PayPalWPP, TEST
from packages.paypal.pro.signals import payment_was_successful, payment_was_flagged
...
class PayPalPro(object):
    ...
    def render_confirm_form(self):
        ...
        contains hidden fields with the token / PayerID from packages.paypal.
        """
